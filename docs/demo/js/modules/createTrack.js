...
module.exports = {
  ...
  oninit: function(vnode) {
    ...
    function node(type, setTo) {
      ...
      if (!type) { return options.nodes.indexOf(type) !== -1 }
  ...
  view: function(vnode) {
    ...
    return [
      m('.row', [
          ...
          m('.input', [
            ...
            m('select', {
              ...
              oninput: function() {
                ...
                if (value === 'Html5Track') { state.remove('nodes') }
                else if (!state.get('nodes')) { state.set('nodes', []) }
              },
              ...
              m('option', {
                value: 'StreamSourceTrack', disabled: true
        ...
        m('.col.is-grow', [
          m('pre.options', [ JSON.stringify(state.options(), ' ', 2) ]),
        ]),
