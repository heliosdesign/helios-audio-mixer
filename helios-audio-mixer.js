...
Track.prototype.addNode = function(nodeType) {
  ...
  if(nodeType === 'analyze') {
    ...
    _this.nodes.processor.onaudioprocess = function(){
      _this.nodes.analyser.getByteTimeDomainData(_this.analyzerData.raw);

      // calculate average, mid, high
      scratch = 0;
      for (var i = 0; i < _this.options.bufferLength; i++)
        scratch += _this.analyzerData.raw[i];

      _this.analyzerData.average = scratch / _this.options.bufferLength;
      ...
      _this.analyzerData.low = scratch / third;
      ...
      _this.analyzerData.mid = scratch / third;
      ...
      _this.analyzerData.high = scratch / third;

      _this.trigger('analyse', _this.analyzerData)
    }
  }
